...
class CardEffectLibrary{
	...
	public static function getEffectCost(e:CardEffect):Int{
		return switch(e){
			case ADD_CURSE_OTHER: 3;
			case ADD_CURSE_SELF: 2;
			case REMOVE_CURSE_OTHER: 2;
			case REMOVE_CURSE_SELF: 3;
			case TAKE_CURSE: 2;
			case GIVE_CURSE: 4;
			case GAIN_POINT: 2;
			case REMOVE_POINT: 3;
			case SEAL_OWN_CURSE: 2;
			case SEAL_OTHER_CURSE: 3;
			case PROTECT_SELF: 4;
			case PROTECT_OTHER: 2;
		}
	}
	...
	public static function getEffectFunction(e:CardEffect):Player->Player->Void{
		return switch(e){
			...
			case GAIN_POINT: (s, o) -> s.points += POINTS_EFFECT_QTY;
			case REMOVE_POINT: (s, o) -> o.points -= POINTS_EFFECT_REMOVE_QTY;
